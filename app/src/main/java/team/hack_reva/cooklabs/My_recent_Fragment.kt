...
import kotlinx.android.synthetic.main.item_view_createlab.*
                ...
                if(!snapshot?.isEmpty!!){
                    ...
                    for (i in snapshot.documents){
                        ...
                        post_pic.child("user-accounts/profile-pictures/$uid_of_author").downloadUrl.addOnSuccessListener {
                            ...
                            no_of_steps?.let { it1 ->
                                Posts(url_of_profile_pic,url_of_cover_pic,name_of_dish,"user-cook-labs/$authuid/recently-viewed-posts/$name_of_dish",
